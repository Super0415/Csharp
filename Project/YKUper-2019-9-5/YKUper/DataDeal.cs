...
namespace Yungku.Common.IOCard.DataDeal
{
    public class DataDeal
    {
        ...
        /// PWM输出的使能状态
        /// </summary>
        public int[] ucPWMstate
        {
            set { ucData.PWMstate = value; }
            get { return ucData.PWMstate; }
        }
        /// <summary>
        /// PWM占空比
        /// </summary>
        public int[] ucDutyCycle
        {
            set { ucData.DutyCycle = value; }
            get { return ucData.DutyCycle; }
        }
        /// <summary>
        /// IO状态
        /// </summary>
        public int ucIOState
        {
