...
namespace YKUper
{
    public partial class MainForm : Form
    {
        ...
        /// 串口实例
        /// </summary>
        public YK_CCASP24WST CCom = new YK_CCASP24WST();
        /// <summary>
        /// 创建窗体S1的句柄
        /// </summary>
        ...
        /// 创建窗体FormYKUCC52的句柄
        /// </summary>
        private FormYKUCC52 formYKUCC52 = null;
        ...
        {
            string[] UperItem = { "自动识别", "S1", "S2","负压表","调光器" };
        ...
        {           
            ...
            {         
                ...
                panel.Controls.Clear();//移除所有控件
                if (formS2 == null) formS2 = new FormS2();      //避免重复创建窗口，只创建一次，之后使用Hide()与Show()实现窗体的变化
            ...
            else if (data.VerUper == 3)     //负压表
            {
                ...
                panel.Controls.Clear();//移除所有控件
                if (formGaugeP == null) formGaugeP = new FormGaugeP();      //避免重复创建窗口，只创建一次，之后使用Hide()与Show()实现窗体的变化
        ...
        private void btnComt_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MyEventCOMVerYTUCC52 != null) MyEventCOMVerYTUCC52();//引发事件             
            }
