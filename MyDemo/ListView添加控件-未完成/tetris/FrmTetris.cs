...
namespace tetris
{
    public partial class FrmTetris : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            if (p != null)
                p.Close();
            //p = new Palette(10,15,20, Color.Silver, pbRun.CreateGraphics(), lbReady.CreateGraphics());
            //p = new Palette(_blockNumX, _blockNumY, _blockColnum, Color.Silver, pbRun.CreateGraphics(), lbReady.CreateGraphics());
            ...
            p.MyEventSender += P_MyEventSender;
        ...
        private void P_MyEventSender(int n)
        {
            //label1.Text = "123";
            //label1.Text = n.ToString();
        }
