    ...
    {     
        ...
        private void Config_Out(int outnum)
        {
            ...
            if ((datadeal.GetNetSoft() == 1))
                ...
                YKS2Com.SetOutputs((byte)MOutput);
        }
        /// <summary>
        /// 开关量-输出口0
        /// </summary>
        ...
        {
            if (State == 0) Lab.BackColor = Color.FromArgb(28, 66, 28);    //灯光-忙
            else Lab.BackColor = Color.FromArgb(44, 255, 44);
        }
        void AxleShowLight(int LightState, int LightIO)
        {
            if (datadeal.GetAxle() == 0)
            {
                ShowLight((LightState >> 1 & 0x1), label17);    //灯光-忙
                ShowLight((LightState >> 3 & 0x1), label13);    //灯光-正极限
                ShowLight((LightState >> 4 & 0x1), label15);    //灯光-原点
                ShowLight((LightState >> 5 & 0x1), label14);    //灯光-负极限
                ShowLight((LightState >> 6 & 0x1), label16);    //灯光-回原点
                ShowLight((LightIO & 0x1), label18);           //灯光-脉冲
                ShowLight((LightIO & 0x2), label26);           //灯光-方向
            }
            else if (datadeal.GetAxle() == 1)
            {
                ShowLight((LightState >> 1 & 0x1), label56);    //灯光-忙
                ShowLight((LightState >> 3 & 0x1), label61);    //灯光-正极限
                ShowLight((LightState >> 4 & 0x1), label59);    //灯光-原点
                ShowLight((LightState >> 5 & 0x1), label60);    //灯光-负极限
                ShowLight((LightState >> 6 & 0x1), label58);    //灯光-回原点
                ShowLight((LightIO & 0x4), label54);           //灯光-脉冲
                ShowLight((LightIO & 0x8), label53);           //灯光-方向
            }
            else
            {
                ShowLight((LightState >> 1 & 0x1), label78);    //灯光-忙
                ShowLight((LightState >> 3 & 0x1), label82);    //灯光-正极限
                ShowLight((LightState >> 4 & 0x1), label80);    //灯光-原点
                ShowLight((LightState >> 5 & 0x1), label81);    //灯光-负极限
                ShowLight((LightState >> 6 & 0x1), label79);    //灯光-回原点
                ShowLight((LightIO & 0x10), label77);           //灯光-脉冲
                ShowLight((LightIO & 0x20), label76);           //灯光-方向
            }
        ...
        private void 版本ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Ver_Co = "Shenzhen Yungku Precision Fisture Co.,Ltd.";
                Ver_Web = "www.yungku.com";
                Ver_Card = "S2 Smart Card.";
                Ver_UD = "xxxx";
                Ver_SPT = "15221283134@163.com";
            }
