...
namespace Yungku.Common.IOCard.DataDeal
{
    class DataDeal
    {
        ...
        public class EngineData
        {
            ...
            //public string Ver_Co;    //版本信息-公司
            //public string Ver_Web;    //版本信息-网址
            //public string Ver_Card;    //版本信息-主板名
            //public string Ver_UD;       //版本信息-版本号
            //public string Ver_SPT;      //版本信息-技术支持
            ...
            while (true)
            {
                ...
                if (Comm.NetHardCon == 1 && Comm.NetSoftCon == 1)  //连接网络
                {
                    ...
                    if (enginedata.FirstNum == 0)  //读取固件信息
                    {
                        ...
                        //获取版本信息
                        enginedata.Ver_Info = YKS2net.GetVer_Info();
