...
namespace YKUper
{
    public partial class FormS1 : Form
    {
        ...
        private void FormS1_Load(object sender, EventArgs e)
        {
            ...
            lForm.MyEventCOMVer1 += new MainForm.MyDelegate(Main_Connet);//监听MainForm窗体事件
            S1data = lForm.data;
