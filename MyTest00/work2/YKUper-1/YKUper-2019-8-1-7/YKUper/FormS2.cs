...
namespace YKUper
{
    public partial class FormS2 : Form
    {
        ...
        private void button_Stop_Click()
        {
            ...
            if ((S2data.GetNetSoft() == 1)/* && !YKS2net.IsBusy(axisNo)*/)
            {
                //YKS2net.Stop(axisNo);
            }
        ...
        public void SetSignSendFirm()
        {
            if ((S2data.GetNetSoft() == 1))
            {
                //YKS2net.SetLimits(S2data.GetAxle(), S2data.GetSignEnLimit(), S2data.GetSignEnOrigin(), S2data.GetSignReLimit(), S2data.GetSignReOrigin());
            }
        ...
        {
            int axis = S2data.Axis;
            //if ((S2data.GetNetHard() == 1) && !YKS2net.IsBusy(axisNo))
            //{
            //    //YKS2net.SetPosition(axisNo, 0);
            //}
            //else if ((S2data.GetCOMSoft() == 1) && !YKS2Com.IsBusy(axisNo))
            //{
